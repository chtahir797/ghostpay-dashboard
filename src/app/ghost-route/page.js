  ...
  return (
    <DashboardLayout>
      <div className="flex flex-col h-full bg-[#000000]">
        {/* Conditional Header */}
        {isComplete ? (
          <header className="py-[23px] px-[25px] border-b border-[#151515] flex items-center justify-between gap-[10px]">
          ...
          <header className="py-[23px] px-[25px] border-b border-[#151515] flex items-center gap-[10px]">
            <button className="p-[6px] hover:bg-[#151515] rounded-[8px] transition-colors">
        ...
        <main className="md:p-[10px] p-[25px] pb-[160px] md:pb-[20px] flex flex-col gap-[20px]">
          {/* desktop  */}
          <div className="hidden md:flex w-[520px] mx-auto pt-[40px] flex-col gap-[24px]">
          ...
          {isComplete ? (
            // Completion View
            <div className="w-full mx-auto flex flex-col items-center gap-[24px] pt-[40px]  md:px-0">
